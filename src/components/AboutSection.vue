        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            <div data-aos="flip-right">
                ...
                <div class="space-y-8 py-8">
                    <div v-for="element in Education" :key="element.id"
                        class="flex items-center md:w-[80%] w-full rounded-xl bg-gradient-to-tr  from-[#3c3f49] to-[#252525] hover:from-[#251810] hover:to-[#796048] shadow-lg ">
                        <div class="w-1/4  md:ml-0 sm:ml-0">
                            <img class="ml-4 " src="https://img.icons8.com/ios-glyphs/60/ffffff/graduation-cap--v1.png" alt="graduation-cap--v1">
                        </div>
                        <div class="w-3/4 pl-4">
                            <h3 class="text-2xl font-semibond uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary lg:text-xl">
                                {{ element.School }}
                            </h3>
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">
                    dsadasvn zxowke,wnelw;d[[pkzjxcnwpekm  dayhsdlka;sd]]
                </p>
                <div class="grid grid-cols-3 gap-4 max-w-lg pt-8 ">
                    <div class="text-center rounded-xl bg-[#616886] shadow-lg border border-[#1f1641] p-3">
